    ...
    if len(text) > 7:
        ...
        if len(argument) == 3:
            ...
            try:
                ...
                return
        temp_msg = await message.reply("пожалуйста, подождите немного ⚡ ")
        try:
        ...
        for msg in messages:
            ...
            try:
                ...
                pass
        await message.reply_text(f"<b><i>\n──────────────────────────\n➥ 𝚃𝚑𝚒𝚜 𝙼𝚊𝚜𝚜𝚊𝚐𝚎 𝚆𝚒𝚕𝚕 𝙱𝚎 𝙳𝚎𝚕𝚎𝚝𝚎𝚍 𝙸𝚗 3 𝙷𝚘𝚞𝚛𝚜.\n➥ должен присоединяйтесь к нашему сообщество для большего😍</i></b>")
        await message.reply_text(f"<b>➥Мы не являемся ни производителем, ни владельцем. everything is taken feom internet</b>")
