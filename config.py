...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1001639151193"))
FORCE_SUB_CHANNEL3 = int(os.environ.get("FORCESUB_CHANNEL3", "-1001639151193"))
...
try:
    ADMINS = [1264280791]
    for x in (os.environ.get("ADMINS", "6038518360").split()):
        ADMINS.append(int(x))
except ValueError:
